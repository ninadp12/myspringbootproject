...
import com.in120minutes.springboot.web.service.TodoRepository;
...
public class TodoController {
	...
	public String showTodos( ModelMap modelMap) {
		...
		modelMap.put("todo", repository.findByUser(name));
...
//		todoService.addTodo(modelMap.get("name").toString(), todo.getDesc(), new Date(), false);
	...
	public String deleteTodoPage(@RequestParam long id ) {
